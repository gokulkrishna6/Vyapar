...
def view_cheque_page (request):

  return render(request, 'company/view_cheque_page.html')
...
def  add_loan_acounts(request):

  return render(request, 'company/add_loan_acounts.html')